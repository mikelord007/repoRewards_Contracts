...
contract DeployScript is Script {
    function run() external {
        ...
        console.log(
            "Tokenized Strategy Address:",
            repoRewards.tokenizedStrategyAddress()
        );
        console.log("Owner:", msg.sender);
        console.log(
            "Note: Each organization will specify its own yield source (ERC4626 vault) during registration"
        );
